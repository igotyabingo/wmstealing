...
def get_p_list(jsonl_file):
    ...
    for line in lines:
        ...
        line = line.strip()
        res_dict = json.loads(line)
        p_list.append(res_dict["detection_result"]["p"])
...
def main():
    ...
    if args.blackbox: 
        total_path = f"./result/{args.attack_name}/demark_black/{args.prompt_set_name}/{args.target_model_id}_{args.prompt_set_name}_black.jsonl"
        gpt_score_path = f"./result/{args.attack_name}/demark_black/{args.prompt_set_name}/{args.target_model_id}_{args.prompt_set_name}_black_gpt.jsonl"
        perplexity_path = f"./result/{args.attack_name}/demark_black/{args.prompt_set_name}/{args.target_model_id}_{args.prompt_set_name}_black_ppl.jsonl"
        evaluation_path = f"./result/{args.attack_name}/demark_black/{args.prompt_set_name}/{args.target_model_id}_{args.prompt_set_name}_black_result.jsonl"
    else: 
        total_path = f"./result/{args.attack_name}/demark_gray/{args.prompt_set_name}/{args.target_model_id}_{args.prompt_set_name}.jsonl"
        gpt_score_path = f"./result/{args.attack_name}/demark_gray/{args.prompt_set_name}/{args.target_model_id}_{args.prompt_set_name}_gpt.jsonl"
        perplexity_path = f"./result/{args.attack_name}/demark_gray/{args.prompt_set_name}/{args.target_model_id}_{args.prompt_set_name}_ppl.jsonl"
        evaluation_path = f"./result/{args.attack_name}/demark_gray/{args.prompt_set_name}/{args.target_model_id}_{args.prompt_set_name}_result.jsonl"
