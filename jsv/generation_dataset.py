...
class GenerationPrompts(Dataset):
    def __init__(self, model_id, prompt_set_name, tokenizer) -> None:
        ...
        elif prompt_set_name == "c4_realnews":
            prompts = get_c4()
        ...
        for prompt in prompts:
            ...
            if (
                ...
                self.prompt_ids.append(cur_prompt_ids)
            elif (model_id == "Qwen/Qwen3-4B-Instruct-2507"               
...
def get_c4():
    prompts = []
    with open("../data/c4_realnewslike_train_30k.jsonl", "r", encoding="utf-8") as f:
        for i, line in enumerate(f):
            ...
            line = line.strip()
            prompts.append(line)
    print(f"c4 dataset with size {len(prompts)} loaded")
    return prompts
